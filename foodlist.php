...
<head>
  ...
  <title>DigitalMini Resturant</title>
...
<body>
  ...
  <a class="navbar-brand" href="index.php">DigitalMini Resturant</a>
...
?>
 ...
 <div class="jumbotron text-center">
   <h1>Welcome To DigitalMini Resturant <i class="fas fa-utensils"></i></h1>
 </div>
 <!--jumbotron code-->
